...
<div class="container">
    ...
    <div class="meun">
       <b>菜单</b><br>
                    ...
                    <li><a href="personal.jsp" target="_self">已借阅<i class="im-screen"></i></a>
                    </li><br/>
                    <li><a href="publish.jsp" target="_self">已发布<i class="st-chart"></i></a>
                    </li> <br/>
                    <li><a href="wait.jsp" target="_self">待借阅<i class="st-chart"></i></a>
                    </li><br />
                     <li><a href="addbook.jsp" target="_self">新发布<i class="st-chart"></i></a>
                    </li>    
     </div> 
    <div class="content">
    <div class="head">
