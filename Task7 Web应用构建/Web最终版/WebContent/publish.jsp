...
<div class="container">
    ...
    <div class="meun">
       <b>菜单</b><br>
                    ...
                    <li><a href="personal.html" target="_self">已借阅</a>
                    </li><br/>
                    <li><a href="publish.html" target="_self">已发布</a>
                    </li> <br/>
                    <li><a href="wait.html" target="_self">待借阅</a>
                    </li><br />
                     <li><a href="addbook.html" target="_self">新发布</a>
                    </li>        
     </div> 
    <div class="content">
      <table border="1" bordercolor="#000000" cellpadding="6" cellspacing="10" class="booktable">
        <tr>
         <td  align="center">
         <div  class="demo">
          <img src="images/banmianshejijichu.jpg"  width="200" height="200" alt="版面设计基础">
          </div>
          <div class="bookName">
          <a href="bookInstruction.html">版面设计基础</a> 
            </div> 
          </td>
         </tr>
         </table>
